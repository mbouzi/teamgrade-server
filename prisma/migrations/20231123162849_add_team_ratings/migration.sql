/*
  ...
  - Added the required column `teamId` to the `Rating` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Rating" ("id", "matchId", "performanceId", "playerId", "score", "userId") SELECT "id", "matchId", "performanceId", "playerId", "score", "userId" FROM "Rating";
DROP TABLE "Rating";
